...
โปรเจกต์นี้ตั้ง `PAYMENT_MODE=test` เป็นค่าเริ่มต้น จึงใช้ Stripe Test mode: หน้าชำระเงินและสถานะคำสั่งซื้อทำงานเหมือนจริง แต่จะไม่ตัดหรือโอนเงินจริง ระบบจะปฏิเสธ `sk_live_...` หากค่านี้ยังเป็น `test`
