...
urlpatterns = [
    ...
    path("messages/<int:pk>/media/", views.conversation_media_upload, name="conversation_media_upload"),
    path("private/messages/<int:message_id>/media/", views.conversation_media, name="conversation_media"),
